    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
       	 Bundle bundle = this.getIntent().getExtras();
	         ...
	         Log.d("food in bundle is", food);
	        
       } catch(Exception e){
       	Log.d("Error in", "obtaining food");
       }
        String imageurl="http://warm-mountain-2574.herokuapp.com/campus_foods/search.json?food="+food+"";
        Log.d("url queried for search is ", imageurl);
        URL url = null;
		try 
		{
		...
		OnItemClickListener abcd= new OnItemClickListener() {
			public void onItemClick(AdapterView parent, View arg1,
						...
						Intent intent = new Intent(SearchResult.this,ShowEvent.class);
